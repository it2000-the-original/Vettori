...
# Form implementation generated from reading ui file 'generatesumvectorDialog.ui'
#
...
class Ui_GenerateSumVector(object):
    def setupUi(self, GenerateSumVector):
        GenerateSumVector.setObjectName("GenerateSumVector")
        GenerateSumVector.resize(534, 273)
        GenerateSumVector.setMinimumSize(QtCore.QSize(534, 273))
        self.gridLayout = QtWidgets.QGridLayout(GenerateSumVector)
        self.gridLayout.setObjectName("gridLayout")
        self.GenerateSumVectorButton = QtWidgets.QPushButton(GenerateSumVector)
        self.GenerateSumVectorButton.setDefault(True)
        self.GenerateSumVectorButton.setObjectName("GenerateSumVectorButton")
        self.gridLayout.addWidget(self.GenerateSumVectorButton, 5, 0, 1, 2)
        self.tabWidget = QtWidgets.QTabWidget(GenerateSumVector)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 486, 175))
        ...
        self.retranslateUi(GenerateSumVector)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(GenerateSumVector)

    def retranslateUi(self, GenerateSumVector):
        _translate = QtCore.QCoreApplication.translate
        GenerateSumVector.setWindowTitle(_translate("GenerateSumVector", "Generate Sum Vector"))
        self.GenerateSumVectorButton.setText(_translate("GenerateSumVector", "Generate Sum Vector"))
        self.label_15.setText(_translate("GenerateSumVector", "Vector Color"))
        self.VectorColorLine.setText(_translate("GenerateSumVector", "#000000"))
        self.PathColorButton.setText(_translate("GenerateSumVector", "Path Color"))
        self.label_19.setText(_translate("GenerateSumVector", "Annotation y pos"))
        self.VectorNameLine.setText(_translate("GenerateSumVector", "Untitled"))
        self.label_18.setText(_translate("GenerateSumVector", "Annotation x pos"))
        self.label_16.setText(_translate("GenerateSumVector", "Annotation Text"))
        self.label_17.setText(_translate("GenerateSumVector", "Vector Name"))
        self.AnnotationTextLine.setText(_translate("GenerateSumVector", "Annotation Text"))
        self.AnnonationMetod.setItemText(0, _translate("GenerateSumVector", "No Annotation"))
        self.AnnonationMetod.setItemText(1, _translate("GenerateSumVector", "Annotation"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("GenerateSumVector", "Visualization"))
        self.label_2.setText(_translate("GenerateSumVector", "point of origin x"))
        self.label.setText(_translate("GenerateSumVector", "point of origin y"))
        self.label_3.setText(_translate("GenerateSumVector", "First Vector"))
        self.label_4.setText(_translate("GenerateSumVector", "Second Vector"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("GenerateSumVector", "Position and size"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    GenerateSumVector = QtWidgets.QDialog()
    ui = Ui_GenerateSumVector()
    ui.setupUi(GenerateSumVector)
    GenerateSumVector.show()
    sys.exit(app.exec_())
